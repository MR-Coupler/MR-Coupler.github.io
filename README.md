...
## Discovered new bugs.
---
We studied the alarms raised by tests generated by MR-Coupler. We find that some of them are plausible true bugs. Here we will update those bugs that have been confirmed by 
developers.